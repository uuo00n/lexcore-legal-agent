...
不要使用 Markdown 标题、加粗符号或分割线。使用短段落，并严格按以下顺序组织：
1. 结论
2. 法律分析
3. 法律依据
...
# Backward-compatible name for integrations that imported the former prompt.
VERIFIER_FINAL_PROMPT = ANSWER_GENERATOR_PROMPT
